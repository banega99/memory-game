...
var row = ['a', 'b']
var column = ['a', 'b']
var imgArr = ['a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r']
console.log(imgArr)
...
function createLevel(){ 
    ...
    for (let i = 0; i < rowCol; i++) {
        ...
        // imgFront.setAttribute('src', `./footb2/${rand2}.png`)
        // var imgBack = document.createElement('img')
        // imgBack.setAttribute('src', './footb2/gold1.png')
        card.className = 'card'
        ...
        // cardsFront[i].style.backgroundImage = `url('./footb2/${rowColCon[rand1]}.png')`
